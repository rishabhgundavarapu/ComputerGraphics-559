...
function myTriAL(t) {
  ...
  // three points of the triangle are 10,10 130,60 10,60
  const s = (50+120+130) * t/3;
  if(s<130){ //length of hypotenuse
    return(lerpPt(triPt1, triPt2, s /130))
  }
  else if (s < 250) return (lerpPt(triPt2, triPt3, (s - 130) / 120));
  else return lerpPt(triPt3, triPt1, (s - 130 - 120) / 50);
