...
let point = new T.PointLight('pink');
point.position.set(0, 0, 5);
scene.add(point);

let point2 = new T.PointLight("green");
point2.position.set(5, 0, 0);
scene.add(point2);

let point3 = new T.PointLight("blue");
point3.position.set(0, 5, 0);
scene.add(point3);

let point4 = new T.PointLight("gold");
point4.position.set(-5, 0, 0);
scene.add(point4);

let point5 = new T.PointLight("red");
point5.position.set(0, 0, -5);
scene.add(point5);
